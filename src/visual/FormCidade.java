...
public class FormCidade extends javax.swing.JDialog {
    ...
    public boolean validaCampos() {
        if (!(txtNome.getText().length() > 0)) {
            JOptionPane.showMessageDialog(null, "Informar o nome da cidade");
            txtNome.requestFocus();
            return false;
        }
        if (!(cbxUF.getSelectedIndex() >= 0)) {
            JOptionPane.showMessageDialog(null, "Informar o Estado");
            cbxUF.requestFocus();
            return false;
        }
    ...
    private void initComponents() {
        ...
        cbxUF.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "AM", "DF", "RS", "SP", "MG", "PR" }));
    ...
    private void btnExcuirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcuirActionPerformed
        ...
        if (opcao == 0) {
            ...
            Cidade obj = listObjetos.get(linhaSeleciona);
            dao.remover(obj);
            atualizaTabela();
        }
